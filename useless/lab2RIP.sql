...
insert into workouts (name,description,difficulty,duration,owner_id) values("Молодая мама","простой набор для восстановления молодых мам после беременности.",2,"00:30:00",1), ("Детский набор","отличный набор для маленьких спортсменов",3,"00:45:00",1);
